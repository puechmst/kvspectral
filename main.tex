...
\Title{Spectral sequences arising from the gauge equation}

% MDPI internal command: Title for citation in the left column
\TitleCitation{Spectral sequences arising from the gauge equation}
...
\Author{Michel Boyom $^{1,\ddagger}$, Stephane Puechmorel $^{2,\ddagger}$* }

%\longauthorlist{yes}

% MDPI internal command: Authors, for metadata in PDF
\AuthorNames{Michel Boyom, Stephane Puechmorel}

% MDPI internal command: Authors, for citation in the left column
\AuthorCitation{Boyom, M.; Puechmorel, S.}
% If this is a Chicago style journal: Lastname, Firstname, Firstname Lastname, and Firstname Lastname.

% Affiliations / Addresses (Add [1] after \address if there is only one affiliation.)
\address{%
$^{1}$ \quad University of Montpellier, IMAG CNRS 
499-554 Rue du Tuel 34090 Montpellier France ; michel.nguiffo-boyom@umontpellier.fr \\
$^{2}$ \quad University of Toulouse, Laboratoire ENAC, 7, Avenue Edouard Belin, Toulouse France; stephane.puechmorel@enac.fr}

% Contact information of the corresponding author
\corres{Correspondence: stephane.puechmorel@enac.fr}
...
\abstract{The gauge equation is a generalization of the conjugacy relation for Koszul connection to bundle morphisms that are not isomorphisms. The existence of non-trivial solution to this equation, especially when duality is imposed upon related connections, gives important information about the geometry of the manifolds considered. In this article, we use the gauge equation to introduce spectral sequences that are further specialized to Hessian structures.}
...
%\publicinvolvement{Please describe how the public (patients, consumers, carers) were involved in the research. Consider reporting against the GRIPP2 (Guidance for Reporting Involveme!nt of Patients and the Public) checklist. If the public were not involved in any aspect of the research add: ``No public involvement in any aspect of this research''.}
